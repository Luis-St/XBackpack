...
public class XBKeyMappings {
	...
	public static final KeyMapping.Category BACKPACK_CATEGORY = new KeyMapping.Category(ResourceLocation.fromNamespaceAndPath(XBackpack.MOD_ID, "key.categories.backpack"));
